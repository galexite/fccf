...
size_t FORCE_INLINE sse2_strstr_anysize(const char *s, size_t n,
...
size_t FORCE_INLINE sse2_strstr_memcmp(const char *s, size_t n,
                                       const char *needle, MEMCMP memcmp_fun) {
  assert(k > 0);
  assert(n > 0);
